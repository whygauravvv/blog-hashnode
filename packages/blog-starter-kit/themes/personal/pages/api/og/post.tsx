						...
						<div tw="flex flex-row items-center">
							{reactions && (
								<div tw="mr-10 flex flex-row items-center">
									<svg fill="#64748b" style={{height:'2rem',width:'2rem',marginRight:'0.75rem'}} viewBox="0 0 512 512">
							...
							{comments && (
								<div tw="flex flex-row items-center">
									<svg fill="#64748b" style={{height:'2rem',width:'2rem',marginRight:'0.75rem'}} viewBox="0 0 576 512">
